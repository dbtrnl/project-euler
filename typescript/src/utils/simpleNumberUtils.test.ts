...
describe('Test simpleNumberUtils', () => {
  ...
  describe('findAllCyclicPermutationsOfNumber', () => {
    ...
    it('should return expected Set when calling function with (123)', () => {
    ...
    it('should return expected Set when calling function with (1230)', () => {
    ...
    it('should return expected Set when calling function with (123456)', () => {
