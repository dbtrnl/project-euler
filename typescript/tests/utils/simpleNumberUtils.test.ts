import {
  ...
  piGenerator,
  firstTenThousandDigitsOfPI,
  firstTenThousandDigitsOfPI2,
  firstThousandDigitsOfPI,
  firstHundredDigitsOfPI,
...
describe('Test simpleNumberUtils', () => {
  ...
  describe('sumAllNumbersInBigIntArray()', () => {
    test('should return 3 when calling function with the specific array', () => {
      const inputArray: bigint[] = [BigInt(1), BigInt(2)]
      const functionOutput = sumAllNumbersInBigIntArray(inputArray)
      expect(Number(functionOutput)).toEqual(3)
    })

    test('should return 18014398509481984n when calling function with the specific array', () => {
      const inputArray: bigint[] = [9007199254740992n, 9007199254740992n]
      const functionOutput = sumAllNumbersInBigIntArray(inputArray)
      expect(functionOutput).toEqual(18014398509481984n)
    })
  })
  ...
  describe.skip('piGenerator()', () => {
    let functionOutput = 0n
    functionOutput = BigInt(piGenerator('10000'))

    expect(functionOutput).toBe(firstTenThousandDigitsOfPI)
    // expect(functionOutput).toBe(firstTenThousandDigitsOfPI2)

    functionOutput = piGenerator('1000')
    expect(functionOutput.toString()).toBe(firstThousandDigitsOfPI.toString())
    // expect(functionOutput.toString()).toBe(firstTenThousandDigitsOfPI.toString().substring(0, 1000))

    functionOutput = piGenerator('100')
    expect(functionOutput.toString()).toBe(firstHundredDigitsOfPI.toString())
    // expect(functionOutput.toString()).toBe(firstTenThousandDigitsOfPI.toString().substring(0, 100))
  })
})
