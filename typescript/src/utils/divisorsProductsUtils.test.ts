...
describe('Test divisorsProductsUtils', () => {
  ...
  describe('findAllProperDivisors()', () => {
    ...
    it('should return expected array when calling function with (1000)', () => {
    ...
    it('should return expected array when calling function with (1001)', () => {
    ...
    it('should return expected array when calling function with (1003)', () => {
  ...
  describe('isAmicableNumber()', () => {
    ...
    it('should return expected object when calling function with (220)', () => {
    ...
    it('should return expected object when calling function with (2620)', () => {
    ...
    it('should return expected object when calling function with (79750)', () => {
    ...
    it('should return expected object when calling function with (221)', () => {
    ...
    it('should return expected object when calling function with (0)', () => {
      const expected: AmicableNumberObject = { isAmicable: false, pair: null }
  ...
  describe('findAmicableNumbersUnder()', () => {
    ...
    it('should return expected array when calling function with (220)', () => {
      const expected = [220, 284]
      const result = findAmicableNumbersUnder(221); expect(result).to.be.deep.equal(expected)
    })

    it('should return the first 20 amicable numbers when calling function with (66993)', () => {
      const expected = [
